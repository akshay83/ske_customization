...
function start_internal_import(next_batch) {
    frappe.call({
        method: "ske_customization.customizations_for_ske.tally_import_stock_internal.process_import",
        args: {
...
function doCallback(r, isLastChunk) {
    ...
    frappe.call({
        method: "ske_customization.customizations_for_ske.page.tally_import.tally_import.read_uploaded_file",
        args: {
