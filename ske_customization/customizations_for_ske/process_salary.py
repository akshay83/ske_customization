...
from ske_customization.customizations_for_ske.report.custom_salary_register.custom_salary_register import get_employee_details
...
def process_staff_salaries_jv(payable_account, date, filters, director):
	...
	for comp, amount in earnings_deductions.iteritems():
		...
		ac1.cost_center = 'Main - SKE' #erpnext.get_default_cost_center(account[0].company)
